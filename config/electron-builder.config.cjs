...
// Why an extraResource and not app.asar: the delegation sidecar is executed as
// `node <path>`, and Node cannot run a script from inside an asar archive.
const delegateSidecarResources = {
